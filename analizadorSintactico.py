...
def DECLARATION(tokens, idx):  # no se como poner expr_stmt
    ...
    elif tokens[idx].type in ["paraToken", "siToken", "imprimirToken", "retornarToken", "mientrasToken", "lcorchToken"]:
...
def PRIMARY(tokens, idx):
    if tokens[idx].type in ["verdaderoToken", "falsoToken", "nuloToken", "esteToken", "floatToken", "integerToken",
                            "stringToken", "idToken", "superToken"]:
        idx += 1
